...
The responsive pagination snapshot is from the host plugin-install-experience worktree. It retains the shared desktop/mobile controls and clamping helper; the unused optional page-size selector is omitted because crawl pages use a fixed size.
